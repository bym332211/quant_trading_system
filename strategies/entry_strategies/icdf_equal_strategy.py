# strategies/entry_strategies/icdf_equal_strategy.py
# -*- coding: utf-8 -*-
"""
ICDF 和等权重入场策略 - 从原有 EntryStrategy 类迁移而来
"""
...
from strategies.entry_strategies import EntryStrategy
...
class ICDFEqualStrategy(EntryStrategy):
    """ICDF 和等权重入场策略"""
